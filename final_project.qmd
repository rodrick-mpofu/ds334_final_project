...
radar_data <- rbind(max_values, fighter_comp[1:6], min_values)

# Plot the radar chart
#radarchart(radar_data, axistype=1,
 #          pcol=c("blue", "red"),
  #         plty=1,
   #        legend=fighter_comp$fighter)
...
# Add a legend
legend(x=0.7, y=1, legend = fighter_comp$fighter, bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)
```
